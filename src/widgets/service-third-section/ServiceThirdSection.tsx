...
export const ServiceThirdSection = () => {
  return (
    <div className={s.container}>
      <p className="body_1">
        Логопром-Сервис" — ведущая компания Беларуси, специализирующаяся на
        разработке, поставке и внедрении высокотехнологичных решений в сфере
        контрольно-измерительных приборов (КИП) и промышленной автоматизации.{" "}
      </p>
