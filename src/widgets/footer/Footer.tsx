      ...
      <div className={s.container}>
        <div className={s.content}>
          ...
          <div className={s.contacts}>
            ...
            <p className="body_2">
              Время работы: 8:30–18:00 Время работы офиса: пн-пт с 9:00 до 17:00
              Выходные дни: суббота, воскресенье. Суббота и воскресенье:
              консультация по телефону 8–033–871–95–68
            </p>
